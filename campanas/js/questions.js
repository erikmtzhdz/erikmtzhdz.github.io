(function(){
    ...
    const titleQuestions = [...document.querySelectorAll('.fechas__title')];
    ...
    titleQuestions.forEach(question =>{
        question.addEventListener('click', ()=>{
            ...
            addPadding.classList.toggle('fechas__padding--add');

            /* Obtener a los hijos en especifico al primero hijo en h3 questions__title para que rote el icono
               de flecha. */
            question.children[0].classList.toggle('fechas__arrow--rotate');
